...
class AioLineBotApi(LineBotApi):
    ...
    async def add_audiences_to_audience_group_async(self, audience_group_id, audiences,
    ...
    async def change_audience_group_authority_level_async(self, authority_level='PUBLIC', timeout=None):
    ...
    async def create_audience_group_async(self, audience_group_name, audiences=[],
    ...
    async def create_click_audience_group_async(self, description, request_id,
    ...
    async def create_imp_audience_group_async(self, description, request_id,
                                  timeout=None):
    ...
    async def create_rich_menu_alias_async(self, rich_menu_alias, timeout=None):
    ...
    async def delete_audience_group_async(self, audience_group_id, timeout=None):
    ...
    async def delete_rich_menu_alias_async(self, rich_menu_alias_id, timeout=None):
    ...
    async def get_audience_group_async(self, audience_group_id, timeout=None):
    ...
    async def get_audience_group_authority_level_async(self, timeout=None):
    ...
    async def get_audience_group_list_async(self, page=1, description=None, status=None, size=20,
    ...
    async def get_followers_ids_async(self, start=None, timeout=None):
    ...
    async def get_rich_menu_alias_async(self, rich_menu_alias_id=None, timeout=None):
    ...
    async def get_rich_menu_alias_list_async(self, timeout=None):
    ...
    async def rename_audience_group_async(self, audience_group_id, description, timeout=None):
    ...
    async def update_rich_menu_alias_async(self, rich_menu_alias_id, rich_menu_alias, timeout=None):
